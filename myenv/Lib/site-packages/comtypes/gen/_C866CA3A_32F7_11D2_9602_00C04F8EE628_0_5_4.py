...
__all__ = [
    ...
    'DISPID_SRRSaveToMemory', 'DISPID_SPEDisplayAttributes',
    'SPSNoun', 'SPRST_INACTIVE_WITH_PURGE', 'SpMMAudioIn',
    'DISPID_SVSLastResult', 'SRAONone', 'SpeechAudioState',
    'SpeechVisemeType', 'DISPID_SOTCategory',
    'DISPID_SOTIsUISupported', 'STSF_CommonAppData',
    'DISPID_SGRInitialState', 'ISpPhoneticAlphabetConverter',
    'DISPID_SVStatus', '_ISpeechVoiceEvents',
    'DISPID_SPIGetDisplayAttributes', '_ISpeechRecoContextEvents',
    'DISPID_SPCLangId', 'DISPID_SOTRemove',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCERecognizerStateChange', 'SPBOOKMARKOPTIONS',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRsDynamic',
    'DISPID_SRCRetainedAudioFormat', 'SPPS_Function',
    'SpeechRecoContextState', 'DISPID_SVSkip', 'SPRECOCONTEXTSTATUS',
    'SGDSActiveUserDelimited', 'SAFT24kHz8BitMono',
    'DISPID_SABufferNotifySize', 'DISPID_SVVolume', 'DISPID_SPRText',
    'DISPID_SVGetProfiles', 'DISPID_SVSInputWordLength',
    'DISPID_SLPsItem', 'SVSFNLPMask', 'DISPID_SRGCmdSetRuleState',
    'SpeechStreamFileMode', 'DISPID_SASNonBlockingIO',
    'SpeechCategoryRecoProfiles', 'DISPID_SOTDataKey',
    'SpeechAudioVolume', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechLexiconWords', 'ISpeechAudio', 'DISPID_SAVolume',
    'SAFT44kHz8BitMono', 'DISPID_SPRulesItem',
    'SPINTERFERENCE_TOOLOUD', 'SPEI_PHRASE_START', 'DISPID_SGRsItem',
    'DISPID_SVEBookmark', 'ISpRecoContext2', 'SAFTGSM610_8kHzMono',
    'SGRSTTEpsilon', 'DISPID_SRGRules', 'DISPID_SPRsCount',
    'DISPID_SVEStreamStart', 'SP_VISEME_4', 'SRAExport',
    'SREStreamStart', 'eLEXTYPE_PRIVATE14', 'SAFTNonStandardFormat',
    'SP_VISEME_17', 'DISPID_SRGSetWordSequenceData',
    'SPCT_SUB_DICTATION', 'DISPID_SPIStartTime', 'ISpPhoneConverter',
    'ISpeechGrammarRuleState', 'DISPID_SVSpeakStream',
    'DISPID_SLPType', 'SVP_15', 'SpStream', 'SpWaveFormatEx',
    'SPCT_SUB_COMMAND', 'SP_VISEME_3', 'DISPID_SpeechObjectTokens',
    'SPRULESTATE', 'ISpEventSink', 'SpeechUserTraining',
    'SpeechTokenKeyAttributes', 'ISpeechTextSelectionInformation',
    'SpeechFormatType', 'SAFTGSM610_11kHzMono',
    'SpeechBookmarkOptions', 'DISPID_SPIEnginePrivateData', 'SASRun',
    'SPDATAKEYLOCATION', 'SINoSignal', 'ISpResourceManager',
    'ISpeechMemoryStream', 'DISPID_SLPsCount', 'DISPID_SPPId',
    'SAFT48kHz16BitMono', 'DISPID_SVAlertBoundary', 'SPPS_LMA',
    'SAFTADPCM_22kHzMono', 'SASClosed', 'DISPID_SRCEventInterests',
    'SGRSTTWord', 'STCRemoteServer', 'DISPID_SWFEChannels',
    'SRADefaultToActive', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SOTsCount', 'eWORDTYPE_DELETED', 'ISequentialStream',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechPhraseRules', 'ISpDataKey',
    'DISPID_SABIBufferSize', '__MIDL_IWinTypes_0009', 'SVP_9',
    'Speech_StreamPos_Asap', 'SAFT8kHz8BitStereo', 'DISPID_SVVoice',
    'SVSFUnusedFlags', 'SPSNotOverriden', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_PRIVATE2', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SFSClose',
    'DISPID_SPIAudioStreamPosition', 'SpFileStream', 'ISpMMSysAudio',
    'SAFT22kHz16BitStereo', 'DISPID_SMSAMMHandle',
    'SpeechTokenShellFolder', 'SRTExtendableParse',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPXRO_Alternates_SML',
    'DISPID_SPILanguageId', 'DISPID_SLWsCount', 'SRSActiveAlways',
    'IInternetSecurityManager', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SGRs_NewEnum', 'DISPID_SRCEEnginePrivate',
    'DISPID_SDKSetLongValue', 'SPSEMANTICFORMAT',
    'DISPID_SOTCGetDataKey', 'SDTAlternates', 'SpeechAudioProperties',
    'SAFTADPCM_8kHzStereo', 'SPCATEGORYTYPE', 'DISPID_SGRSTText',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechDataKey',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhoneConverter',
    'SBONone', 'SpeechRuleState', 'SREFalseRecognition', 'SITooQuiet',
    'SAFT12kHz8BitStereo', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRGetPropertyString', 'DISPID_SLWs_NewEnum',
    'SpeechMicTraining', 'DISPID_SGRAddResource',
    'DISPID_SPIAudioSizeTime', 'SpeechWordType',
    'ISpeechObjectTokenCategory', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SpeechLexiconProns',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPPValue',
    'DISPID_SVEViseme', 'ISpRecoResult', 'DISPID_SOTs_NewEnum',
    'DISPID_SPIEngineId', 'DISPID_SPAs_NewEnum', 'SPAS_CLOSED',
    'DISPID_SRCEPropertyStringChange', 'SPSHORTCUTTYPE',
    'DISPID_SDKGetStringValue', 'SPRECOGNIZERSTATUS',
    'SpeechSpecialTransitionType', 'SpeechRecognitionType',
    'SpeechAllElements', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPRuleConfidence', 'SPWORDPRONOUNCEABLE',
    'SAFT16kHz16BitStereo', 'ISpEventSource', 'SVP_13', 'SpVoice',
    'ISpeechLexicon', 'DISPIDSPTSI_SelectionOffset', 'SPEI_MAX_SR',
    'DISPID_SPERetainedSizeBytes', 'SpeechEngineProperties',
    'DISPID_SPCPhoneToId', 'SVP_0', 'SSTTTextBuffer',
    'SpeechEmulationCompareFlags', 'DISPID_SPPsItem',
    'SPINTERFERENCE_NONE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SVSPhonemeId', 'SRSInactiveWithPurge', 'SVSFIsXML',
    'SVSFParseAutodetect', 'SPSEMANTICERRORINFO', 'SVSFNLPSpeakPunc',
    'DISPID_SRRSpeakAudio', 'SPPHRASEELEMENT', 'SREHypothesis',
    'SAFT11kHz8BitStereo', 'DISPID_SVIsUISupported',
    'DISPID_SGRSTRule', 'SpeechPropertyComplexResponseSpeed',
    'SPEI_RESERVED1', 'DISPID_SRGetFormat', 'SGRSTTTextBuffer',
    'SpeechPropertyAdaptationOn', 'UINT_PTR', 'eLEXTYPE_RESERVED7',
    'SAFTADPCM_44kHzMono', 'SDTReplacement', 'SPGRAMMARSTATE',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCRequestedUIType',
    'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE8', 'SPEI_SR_PRIVATE',
    'SRTSMLTimeout', 'STCInprocServer', 'SAFTCCITT_uLaw_44kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SASFreeBufferSpace',
    'SPSHT_NotOverriden', 'ISpObjectWithToken',
    'DISPID_SVSRunningState', 'SpeechGrammarTagDictation',
    'DISPID_SRStatus', 'DISPID_SPEAudioSizeTime', 'SPAS_PAUSE',
    'Speech_StreamPos_RealTime', 'DISPID_SLAddPronunciation',
    'SAFT11kHz16BitStereo', 'ISpAudio', 'DISPID_SDKDeleteKey',
    'SPDKL_LocalMachine', 'ISpeechVoice', 'SpeechRecoEvents',
    'SVSFParseSsml', 'SPSLMA', 'SVP_21', 'SPSHORTCUTPAIR',
    'DISPID_SGRSTPropertyName', 'DISPID_SVEStreamEnd',
    'DISPID_SDKGetlongValue', 'DISPID_SWFEBlockAlign', 'SP_VISEME_13',
    'ISpeechCustomStream', 'DISPID_SRCEBookmark',
    'SAFT24kHz8BitStereo', 'DISPID_SASetState',
    'DISPID_SPRules_NewEnum', 'DISPID_SpeechMemoryStream',
    'SRTAutopause', 'DISPID_SGRSTPropertyValue', 'STSF_LocalAppData',
    'SLODynamic', 'SVP_2', 'DISPID_SRIsUISupported', 'SVP_8',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SGSEnabled',
    'DISPID_SRAudioInputStream', 'SpeechVoiceCategoryTTSRate',
    'SRESoundStart', 'DISPID_SRRSetTextFeedback', 'ISpRecognizer',
    'SAFT12kHz8BitMono', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SDKEnumValues', 'SPSFunction', 'SPSUnknown', 'SPBO_NONE',
    'DISPID_SRAudioInput', 'DISPID_SPCIdToPhone', 'ISpObjectToken',
    'STSF_AppData', 'DISPID_SpeechRecoResultTimes',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechPhraseAlternates',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTDisplayUI',
    'SAFTADPCM_8kHzMono', 'DISPID_SBSWrite',
    'DISPID_SRRTOffsetFromStart', 'SPSHT_EMAIL', 'DISPID_SpeechAudio',
    'DISPID_SGRAttributes', 'SVP_17', 'DISPID_SPEPronunciation',
    'SVEWordBoundary', 'SDA_No_Trailing_Space', 'IEnumSpObjectTokens',
    'ISpRecoContext', 'SPWT_PRONUNCIATION', 'eLEXTYPE_PRIVATE18',
    'SAFTCCITT_uLaw_8kHzMono', 'Speech_Max_Word_Length',
    'DISPID_SPARecoResult', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SGRSTPropertyId',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPHRASE',
    'SPRS_ACTIVE', 'DISPIDSPRG', 'SPFM_OPEN_READONLY', 'SPAR_Low',
    'SPAR_High', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE3', 'DISPID_SVEAudioLevel',
    'SDTRule', 'DISPID_SRCEEndStream', 'SVP_11',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechFileStream',
    'SDA_Consume_Leading_Spaces', 'SRSEDone', 'ISpXMLRecoResult',
    'SPWT_LEXICAL', 'DISPID_SPEAudioStreamOffset', 'SWTDeleted',
    'SpNotifyTranslator', 'ISpeechRecoContext',
    'DISPID_SpeechPhraseAlternates', 'SAFT16kHz8BitMono', 'SVF_None',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechVoiceSkipTypeSentence',
    'SAFT22kHz8BitMono', 'SAFT22kHz16BitMono', 'SP_VISEME_15',
    'SP_VISEME_18', 'SP_VISEME_7', 'SPWF_SRENGINE',
    'DISPID_SVPriority', 'SPWF_INPUT',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SABIEventBias',
    'SREPhraseStart', 'DISPID_SRGDictationSetState',
    'Speech_Default_Weight', 'DISPID_SPRuleChildren',
    'DISPID_SDKSetStringValue', 'DISPID_SVDisplayUI',
    'DISPID_SRGReset', 'SPSModifier', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SLWLangId',
    'ISpeechGrammarRules', 'DISPID_SpeechRecognizer',
    'eLEXTYPE_PRIVATE1', 'SAFT8kHz16BitMono', '_SPAUDIOSTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCEHypothesis',
    'SPCS_DISABLED', 'SPEI_ADAPTATION', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSInputSentencePosition', 'STCInprocHandler',
    'DISPID_SRCEStartStream', 'DISPID_SpeechPhraseReplacements',
    'SPGS_DISABLED', 'SPEI_RESERVED3',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT12kHz16BitMono',
    'SpeechAudioFormatType', 'SPEI_SOUND_START', 'SAFT24kHz16BitMono',
    'SECFIgnoreCase', 'SECFNoSpecialChars', 'SVEBookmark',
    'DISPID_SPAsCount', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRSNumberOfActiveRules',
    'SITooFast', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SpeechCustomStream', 'SVESentenceBoundary', 'SPSHT_OTHER',
    'ISpeechGrammarRule', 'DISPID_SOTCDefault',
    'DISPID_SRGCmdSetRuleIdState', 'SPPS_NotOverriden',
    'ISpRecognizer3', 'SGDSInactive', 'SDA_Two_Trailing_Spaces',
    'DISPID_SVSInputSentenceLength', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SDKDeleteValue', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRSSupportedLanguages', 'SSSPTRelativeToEnd',
    'SPSMF_SAPI_PROPERTIES', 'SPSERIALIZEDPHRASE', 'SPPHRASERULE',
    'DISPID_SGRClear', 'ISpeechPhraseElement',
    'DISPID_SPIRetainedSizeBytes', 'ISpPhraseAlt',
    'DISPID_SPEAudioTimeOffset', 'SPEI_TTS_BOOKMARK',
    'DISPID_SLPPhoneIds', 'DISPID_SWFEFormatTag', 'SPEI_PHONEME',
    'SVSFPurgeBeforeSpeak', 'DISPID_SCSBaseStream',
    'DISPID_SPPNumberOfElements', 'SDKLDefaultLocation',
    'SRAInterpreter', 'SVSFParseSapi', 'DISPID_SGRSTWeight',
    'SpeechDisplayAttributes', 'DISPID_SWFEBitsPerSample',
    'DISPID_SGRSAddRuleTransition', 'SPPS_RESERVED2',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SMSSetData',
    'SVSFlagsAsync', 'DISPID_SRRecognizer', 'SpMMAudioOut',
    'SpeechWordPronounceable', 'SPEI_END_SR_STREAM',
    'SpeechTokenIdUserLexicon', 'SP_VISEME_12', 'SPTEXTSELECTIONINFO',
    'SINoise', 'SPGS_EXCLUSIVE', 'SSFMCreate', 'SpObjectToken',
    'DISPID_SVEventInterests', 'DISPID_SRIsShared',
    'DISPID_SWFESamplesPerSec', 'SGPronounciation',
    'DISPID_SLPLangId', 'SPFM_CREATE', 'SECLowConfidence',
    'SDTDisplayText', 'eLEXTYPE_PRIVATE16', 'SVP_1',
    'DISPID_SVGetAudioInputs', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseInfo', 'SpeechPropertyResponseSpeed',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIReplacements',
    'ISpGrammarBuilder', 'SPPHRASEPROPERTY', 'SPAO_RETAIN_AUDIO',
    'STCLocalServer', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_PRIVATE10', 'SGRSTTWildcard', 'SPINTERFERENCE_TOOFAST',
    'SVP_7', 'DISPID_SVSLastStreamNumberQueued', 'SDTAudio',
    'DISPID_SGRName', 'DISPID_SRRAudioFormat',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPAsItem', 'SPRST_INACTIVE',
    'ISpeechPhraseRules', 'SPPS_Noun', 'DISPID_SOTGetStorageFileName',
    'ISpRecognizer2', 'DISPID_SPPName', 'SAFT44kHz16BitMono',
    'SpeechRecognizerState', 'SGRSTTDictation',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPPConfidence', 'SP_VISEME_0',
    'SAFT8kHz16BitStereo', 'SpeechVoiceSpeakFlags', 'ISpVoice',
    'SpResourceManager', 'SAFTGSM610_22kHzMono',
    'SpeechPropertyHighConfidenceThreshold', 'SPAUDIOOPTIONS',
    'SPEI_MIN_TTS', 'SPEI_MAX_TTS', 'DISPIDSPTSI_ActiveOffset',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechPhraseProperty',
    'SpInprocRecognizer', 'SPDKL_DefaultLocation',
    'DISPID_SRRTLength', 'DISPID_SRCBookmark', 'SPCT_COMMAND',
    'SREPrivate', 'DISPID_SpeechPhraseReplacement', 'SPEVENTENUM',
    'ISpPhrase', 'SGLexicalNoSpecialChars',
    'ISpeechPhraseReplacement', 'SSSPTRelativeToCurrentPosition',
    'eLEXTYPE_PRIVATE12', 'SPPS_RESERVED1',
    'DISPID_SAFSetWaveFormatEx', 'ISpeechRecoResultTimes',
    'SAFT32kHz16BitStereo', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_9',
    'ISpeechAudioFormat', 'DISPID_SRCCreateGrammar',
    'DISPID_SLPs_NewEnum', 'SpeechPropertyResourceUsage',
    'ISpeechBaseStream', 'SPLOADOPTIONS', 'DISPID_SpeechRecoContext',
    'SRAORetainAudio', 'SP_VISEME_10', 'DISPID_SVEVoiceChange',
    'SPEVENT', 'SVP_3', 'SAFT48kHz8BitMono', 'SPEI_MIN_SR',
    'LONG_PTR', 'SVEEndInputStream', 'DISPID_SRGIsPronounceable',
    'SECFDefault', 'eLEXTYPE_PRIVATE9', 'SpUnCompressedLexicon',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SAFGuid',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechRecognizerStatus',
    'SAFT32kHz8BitMono', 'DISPID_SRSetPropertyString',
    'ISpeechXMLRecoResult', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SLWType', 'SGSExclusive', 'DISPID_SVAudioOutput',
    'DISPID_SRDisplayUI', 'DISPIDSPTSI_SelectionLength',
    'SPEI_START_SR_STREAM', 'SAFT16kHz16BitMono', 'ISpLexicon',
    'DISPID_SPRNumberOfElements', 'DISPID_SVSInputWordPosition',
    'ISpObjectTokenCategory', 'DISPID_SLGetWords', 'SAFTDefault',
    'SECFEmulateResult', 'DISPID_SGRSAddSpecialTransition',
    'eLEXTYPE_PRIVATE11', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SPAO_NONE', 'SpPhraseInfoBuilder',
    'DISPID_SVEPhoneme', 'SpSharedRecognizer', 'DISPID_SDKOpenKey',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPRs_NewEnum',
    'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRRGetXMLResult',
    'DISPID_SLRemovePronunciation', 'ISpStream',
    'SpeechCategoryRecognizers', 'DISPID_SRGDictationLoad',
    'DISPID_SGRsFindRule', 'DISPID_SPPsCount',
    'Speech_Max_Pron_Length', 'DISPID_SRRTimes', 'DISPID_SRCResume',
    'ISpRecoGrammar2', 'DISPID_SRCEPropertyNumberChange',
    'SpeechRunState', 'SPVISEMES', 'SpeechCategoryAudioOut',
    'DISPID_SREmulateRecognition', 'SPEI_FALSE_RECOGNITION',
    'SpLexicon', 'SPBO_AHEAD', 'DISPID_SRCESoundEnd', 'DISPID_SRGId',
    'SVEViseme', 'SVSFIsFilename', 'SDTPronunciation',
    'DISPID_SGRSAddWordTransition', 'SPVPRI_OVER',
    'eLEXTYPE_RESERVED10', 'SPDKL_CurrentConfig',
    'DISPID_SLWPronunciations', 'DISPID_SVRate',
    'DISPID_SPEDisplayText', 'SWTAdded', 'DISPID_SRRTTickCount',
    'SPEI_UNDEFINED', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT48kHz8BitStereo', 'STCAll', 'SP_VISEME_16',
    'SPXMLRESULTOPTIONS', 'SpPhoneConverter',
    'SWPUnknownWordUnpronounceable', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPAPhraseInfo', 'DISPID_SOTGetDescription',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPERequiredConfidence',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPPS_Verb', 'SREAudioLevel',
    'DISPID_SpeechLexiconWord', 'SWPKnownWordPronounceable',
    'SPEI_INTERFERENCE', 'SPWT_DISPLAY', 'ISpNotifyTranslator',
    'DISPID_SOTSetId', 'IEnumString', 'DISPID_SLPSymbolic',
    'SPWORDPRONUNCIATION', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRGRecoContext', 'SFTInput',
    'SpeechCategoryPhoneConverters', 'SpeechLoadOption',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTMatchesAttributes',
    'DISPID_SDKCreateKey', 'SpInProcRecoContext',
    'SPINTERFERENCE_NOISE', 'DISPIDSPTSI', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_PRIVATE5', 'SRESoundEnd', 'SPEI_RESERVED5',
    'DISPID_SASCurrentDevicePosition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_RESERVED4',
    'SVEPhoneme', 'DISPID_SGRsAdd', 'SVF_Stressed',
    'ISpeechLexiconWord', 'ISpeechPhraseProperties', 'SP_VISEME_1',
    'DISPID_SpeechBaseStream', 'SPEI_REQUEST_UI', 'SGLexical',
    'DISPID_SVGetVoices', '_RemotableHandle', 'DISPID_SBSSeek',
    'DISPID_SLGetPronunciations', 'SpeechRecoProfileProperties',
    'DISPID_SLPPartOfSpeech', 'tagSPPROPERTYINFO', 'SPRS_INACTIVE',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SAStatus', 'SPPS_Unknown',
    'SpeechRetainedAudioOptions', 'SpeechRuleAttributes',
    'SRTStandard', 'eLEXTYPE_RESERVED9', 'DISPID_SLWWord',
    'eLEXTYPE_PRIVATE17', 'SVP_5', 'DISPID_SVESentenceBoundary',
    'DISPID_SRSClsidEngine', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPPFirstElement', 'SP_VISEME_20', 'SPWORDTYPE',
    'SVSFIsNotXML', 'SPCONTEXTSTATE', 'SPFM_NUM_MODES',
    'SPLO_DYNAMIC', 'ISpeechRecognizerStatus',
    'DISPID_SpeechPhraseElement', 'DISPID_SRProfile',
    'ISpeechObjectToken', 'SPRECORESULTTIMES',
    'SAFTCCITT_ALaw_8kHzMono', 'SVP_10', 'SECFIgnoreWidth',
    'DISPID_SpeechGrammarRule', 'STSF_FlagCreate', 'SPSSuppressWord',
    'DISPID_SVSLastBookmarkId', 'SPAR_Unknown', 'DISPID_SPRulesCount',
    'SRARoot', 'SBOPause', 'SpeechDiscardType',
    'SpeechPropertyLowConfidenceThreshold', 'SpSharedRecoContext',
    'DISPID_SPRuleParent', 'DISPID_SVResume', 'DISPID_SGRSTsItem',
    'SPXRO_SML', 'SPDKL_CurrentUser', 'SVSFVoiceMask', 'SRCS_Enabled',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechLexiconPronunciation',
    'DISPID_SRCRecognizer', 'ISpeechPhraseInfoBuilder',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRuleName', 'SpCustomStream',
    'ISpeechPhraseInfo', 'SSTTWildcard', 'ISpNotifySource',
    'SP_VISEME_6', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechPhoneConverter', 'DISPID_SABIMinNotification',
    'DISPID_SPACommit', 'SRAImport', 'DISPID_SRCVoice',
    'SAFT22kHz8BitStereo', 'SASStop', 'DISPID_SPRsItem',
    ...
    'ISpeechMMSysAudio', 'DISPID_SGRSTs_NewEnum', 'SPEI_VISEME',
    'SITooLoud', 'DISPID_SpeechRecoResult', 'SPSHT_Unknown',
    'SECHighConfidence', 'SPCT_DICTATION', 'SAFT11kHz8BitMono',
    'SpTextSelectionInformation', 'SPGS_ENABLED', 'SPRST_NUM_STATES',
    'SpeechStreamSeekPositionType', 'DISPID_SBSFormat',
    'DISPID_SPERetainedStreamOffset', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechAudioBufferInfo', 'ISpRecoCategory',
    'SVEVoiceChange', 'DISPID_SVSLastBookmark',
    'ISpeechPhraseElements', 'DISPID_SPRuleFirstElement',
    'DISPID_SPIGetText', 'SECNormalConfidence',
    'DISPID_SVAudioOutputStream', 'DISPID_SMSADeviceId',
    'ISpeechVoiceStatus', 'DISPID_SpeechLexicon',
    'DISPID_SPAStartElementInResult', 'SITooSlow',
    'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCERecognitionForOtherContext', 'ISpNotifySink',
    'SASPause', 'DISPID_SpeechObjectToken', 'SPVPRI_ALERT',
    'SRERecognition', 'SPSERIALIZEDRESULT', 'DISPID_SOTsItem',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRFirstElement',
    'DISPID_SVEEnginePrivate', 'eWORDTYPE_ADDED', 'SPBINARYGRAMMAR',
    'IStream', 'SAFT11kHz16BitMono', 'SAFTText',
    'DISPID_SRRRecoContext', 'ISpSerializeState', 'ISpeechRecognizer',
    'ISpShortcut', 'DISPID_SRRDiscardResultInfo',
    'SPSTREAMFORMATTYPE', 'SPVPRI_NORMAL', 'SP_VISEME_2', 'SVP_14',
    'SpeechCategoryVoices', 'DISPID_SpeechMMSysAudio',
    'DISPID_SASState', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFT8kHz8BitMono', 'ISpeechPhraseReplacements',
    'DISPID_SDKEnumKeys', 'DISPID_SLGetGenerationChange',
    'SGDSActiveWithAutoPause', 'SpeechInterference',
    'SPWORDPRONUNCIATIONLIST', 'SPAS_RUN',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVP_20', 'eLEXTYPE_RESERVED8',
    'DISPID_SPELexicalForm', 'SPCS_ENABLED', 'SDTAll',
    'DISPID_SRCEAudioLevel', 'DISPID_SpeechVoice', 'ISpRecoGrammar',
    'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SAFType',
    'SAFT12kHz16BitStereo', 'SPPARTOFSPEECH', 'DISPID_SVSVisemeId',
    'SpeechGrammarState', 'SPWORDLIST', 'ISpeechObjectTokens',
    'DISPID_SPRDisplayAttributes', 'SREPropertyStringChange',
    'SGDisplay', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPEActualConfidence', 'SVPAlert', 'SVEAudioLevel',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRState',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRGCmdLoadFromObject', 'SpAudioFormat',
    'DISPID_SLGenerationId', 'DISPID_SPIGrammarId', 'SPAR_Medium',
    'SpeechEngineConfidence', 'SREAllEvents', 'DISPID_SRCESoundStart',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechAudioStatus',
    'SpObjectTokenCategory', 'SP_VISEME_8',
    'DISPID_SRGSetTextSelection', 'SRADynamic', 'ISpeechPhraseRule',
    'SPRECOSTATE', 'DISPID_SOTCId', 'SpeechPartOfSpeech',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPIAudioSizeBytes', 'SLTUser',
    'SPEI_SR_BOOKMARK', 'SP_VISEME_11', 'DISPID_SPPs_NewEnum',
    'SREStateChange', 'ISpProperties', 'DISPID_SMSALineId',
    'SPWAVEFORMATTYPE', 'SP_VISEME_19', 'DISPID_SRSAudioStatus',
    'SP_VISEME_21', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCEPhraseStart',
    'SDTLexicalForm', 'ISpeechRecoResultDispatch',
    'SpeechTokenContext', 'SpeechGrammarTagWildcard',
    'DISPID_SPIElements', 'SVSFDefault', 'SpShortcut',
    'SpeechVisemeFeature', 'DISPID_SRGCmdLoadFromMemory',
    'SRERecoOtherContext', 'DISPID_SpeechWaveFormatEx', 'SGRSTTRule',
    'SpeechCategoryAudioIn', 'SRTEmulated', 'ISpeechRecoResult',
    'ISpeechRecoResult2', 'SVP_16', 'DISPID_SPRuleId',
    'DISPID_SpeechPhraseRule', 'SSFMOpenForRead', 'SGDSActive',
    'DISPID_SPEs_NewEnum', 'SSTTDictation', 'DISPID_SRCState',
    'SPPS_SuppressWord', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechAudioFormat', 'SPCT_SLEEP', 'DISPID_SMSGetData',
    'SpeechLexiconType', 'DISPID_SVPause', 'SSFMCreateForWrite',
    'eLEXTYPE_PRIVATE4', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPINTERFERENCE_TOOSLOW', 'SPFILEMODE', 'SpeechAddRemoveWord',
    'DISPID_SRCPause', 'SPFM_OPEN_READWRITE', 'SPLO_STATIC',
    'DISPID_SGRsCount', 'eLEXTYPE_APP', 'SDKLCurrentUser',
    'DISPID_SLWsItem', 'SPSVerb', 'DISPID_SGRSRule',
    'SPFM_CREATE_ALWAYS', 'SAFT32kHz8BitStereo',
    'SAFT44kHz16BitStereo', 'SVSFPersistXML', 'ISpeechResourceLoader',
    'SVPOver', 'DISPID_SRGCommit', 'DISPID_SPPEngineConfidence',
    'SREAdaptation', 'SPSMF_UPS', 'SPSInterjection',
    'SpeechVoiceEvents', 'SVP_12', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SLOStatic',
    'SAFTADPCM_11kHzMono', 'SDTProperty', 'SPINTERFERENCE',
    'SSSPTRelativeToStart', 'DISPID_SGRSTType', 'DISPID_SVEWord',
    'SRATopLevel', 'SPEI_TTS_PRIVATE', 'DISPID_SRRAlternates',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_RESERVED6',
    'DISPID_SPRuleNumberOfElements',
    'DISPID_SOTRemoveStorageFileName', 'SRTReSent',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRRTStreamTime',
    'SPPS_Noncontent', 'DISPID_SABufferInfo',
    'SpeechPropertyNormalConfidenceThreshold',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRSTsCount',
    'SDKLCurrentConfig', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCRetainedAudio', 'SpeechGrammarWordType', 'SPWORD',
    'SPPS_Interjection', 'DISPID_SPEsItem', 'ISpeechRecoGrammar',
    'SpeechTokenValueCLSID', 'ISpeechAudioBufferInfo', 'SVF_Emphasis',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCreateRecoContext', 'SVSFParseMask', 'DISPID_SBSRead',
    'DISPID_SGRSTransitions', 'DISPID_SRCSetAdaptationData',
    'SFTSREngine', 'DISPID_SPPParent', 'SAFT32kHz16BitMono',
    'SREStreamEnd', 'SPEVENTSOURCEINFO', 'tagSTATSTG',
    'DISPID_SRCEAdaptation', 'DISPID_SGRId', 'ISpeechFileStream',
    'SRSActive', 'DISPID_SPIRule', 'SVEPrivate', 'SP_VISEME_5',
    'DISPID_SRRGetXMLErrorInfo', 'SPAS_STOP',
    'IInternetSecurityMgrSite', 'DISPID_SVGetAudioOutputs',
    'DISPID_SOTId', 'DISPID_SpeechRecoResult2',
    'DISPID_SAEventHandle', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSTNextState',
    'SPGRAMMARWORDTYPE', 'SAFTGSM610_44kHzMono',
    'DISPID_SAFGetWaveFormatEx', 'SDKLLocalMachine', 'SVPNormal',
    'DISPID_SRGDictationUnload', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechVoicePriority', 'DISPID_SGRsCommit', 'DISPID_SOTCSetId',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_SENTENCE_BOUNDARY',
    'SPRST_ACTIVE', 'SPEI_RESERVED2', 'SpeechDictationTopicSpelling',
    'ISpeechPhraseProperty', 'SP_VISEME_14',
    'DISPID_SpeechAudioStatus', 'DISPID_SOTCreateInstance',
    'DISPID_SRSCurrentStreamPosition', 'SRSEIsSpeaking', 'SPRULE',
    'SPBO_PAUSE', 'SPBO_TIME_UNITS', 'DISPID_SGRAddState',
    'DISPID_SRCERequestUI', 'eLEXTYPE_PRIVATE13',
    'SpeechTokenKeyFiles', 'SGSDisabled', 'SDA_One_Trailing_Space',
    'ISpStreamFormat', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_4',
    'SWPUnknownWordPronounceable', 'SPEI_SR_RETAINEDAUDIO',
    'SRSInactive', 'WAVEFORMATEX', 'DISPID_SRGCmdLoadFromResource',
    'SPLEXICONTYPE', 'SPPHRASEREPLACEMENT', 'SECFIgnoreKanaType',
    'SVP_6', 'ISpeechWaveFormatEx', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechPhraseElements', 'SINone',
    'SAFTExtendedAudioFormat', 'SREInterference', 'DISPID_SPEsCount',
    'DISPID_SADefaultFormat', 'DISPID_SpeechPhraseBuilder',
    'ISpeechGrammarRuleStateTransitions', 'SVEStartInputStream',
    'SPEI_RECOGNITION', 'SpCompressedLexicon', 'DISPID_SRRAudio',
    'SpStreamFormatConverter', 'SRCS_Disabled', 'SpeechTokenKeyUI',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_END_INPUT_STREAM',
    'SPAUDIOSTATE', 'SRERequestUI', 'DISPID_SVSpeak', 'SVEAllEvents',
    'DISPID_SPEAudioSizeBytes', 'SVP_19', 'SPVPRIORITY',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechRecoContextEvents',
    'SREBookmark', 'DISPID_SpeechVoiceStatus',
    'DISPID_SDKGetBinaryValue', 'SPPROPERTYINFO',
    'DISPID_SWFEExtraData', 'DISPID_SRCEFalseRecognition', 'SLTApp',
    'SAFT16kHz8BitStereo', 'SpMMAudioEnum', 'SREPropertyNumChange',
    'ISpeechLexiconWords', 'DISPID_SRCERecognition', 'SPPS_Modifier',
    ...
    'DISPID_SPPChildren', 'SPAUDIOSTATUS', 'SpeechDataKeyLocation',
    'SPVOICESTATUS', 'eLEXTYPE_PRIVATE7', 'DISPID_SFSOpen',
    'DISPID_SpeechDataKey', 'SAFTNoAssignedFormat',
    'DISPID_SPEEngineConfidence', 'SVP_18', 'DISPID_SRCEInterference',
